                    ...
                    >
                        <div>
                            ...
                            <p className="text-white/70 text-[16px] lg:text-[18px] leading-relaxed font-light mb-6" style={{ fontFamily: "'Inter', sans-serif" }}>
                                This sophisticated kitchen seamlessly blends form and function. Every element has been carefully curated to create a space that inspires culinary creativity.
                            </p>
                            <p className="text-white/70 text-[16px] lg:text-[18px] leading-relaxed font-light" style={{ fontFamily: "'Inter', sans-serif" }}>
                                Premium materials, intelligent storage solutions, and state-of-the-art appliances come together in perfect harmony.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-6 text-white/70 text-[15px] leading-relaxed font-light" style={{ fontFamily: "'Inter', sans-serif" }}>
                                <li className="flex items-start">
                                    ...
                                    <span>White quartz countertops with waterfall edge</span>
                                </li>
                                <li className="flex items-start">
                                    <span className="text-[#c9a961] mr-4">—</span>
                                    <span>Matte black custom cabinetry with soft-close mechanisms</span>
                                </li>
                                <li className="flex items-start">
                                    <span className="text-[#c9a961] mr-4">—</span>
                                    <span>Professional-grade stainless steel appliances</span>
                                </li>
                                <li className="flex items-start">
                                    <span className="text-[#c9a961] mr-4">—</span>
                                    <span>Marble backsplash with matching island</span>
                                </li>
                                <li className="flex items-start">
                                    <span className="text-[#c9a961] mr-4">—</span>
                                    <span>Designer pendant lighting and recessed LED strips</span>
                                </li>
                                <li className="flex items-start">
                                    <span className="text-[#c9a961] mr-4">—</span>
                                    <span>Custom breakfast bar with designer seating</span>
                                </li>
                            </ul>
                        </div>
                    </motion.div>
...
export default PenthouseKitchen
